...
print_usage() {
	...
	echo "Add or verify signatures and optionally open dm-verity volume."
	echo ""
	echo "Examples:"
	echo " Create container and sign with keyfile:"
	echo "  container-util --keyfile private.pem rootfs.container"
	echo " Create container and sigh with pkcs11:"
	echo "  container-util --key-pkcs11 \"pkcs11:token=ms;object=test;pin-value=123456\" rootfs.container"
	echo " Verify container with keyfile:"
	echo "  container-util --pubkey private.pem rootfs.container"
	echo " Verify container with pkcs11:"
	echo "  container-util --pubkey-pkcs11 \"pkcs11:token=ms;object=test\" rootfs.container"
	echo " Open dm-verify mapping at /dev/mapper/rootfs"
	echo "  container-util --pubkey-any --open rootfs rootfs.container"
	echo " Close opened dm-verity mapping at /dev/mapper/rootfs"
	echo "  veritysetup close rootfs"
	echo ""
	echo "Options:"
